              ...
              m("ul", [
                m("li", [
                  m("a", {target: "_blank", href: "http://twitter.com/AdvGuildGame"}, [
                    m("i", {class: "fa fa-twitter fa-fw"}),
                    "@AdvGuildGame"
                  ])
                ]),
                m("li", [
                  m("a", {target: "_blank", href: "http://facebook.com/AdventureGuildGame"}, [
                    m("i", {class: "fa fa-facebook-official fa-fw"}),
                    "/AdventureGuildGame"
                  ])
                ]),
                m("li", [
                  m("a", {target: "_blank", href: "http://reddit.com/r/adventureguild"}, [
                    m("i", {class: "fa fa-reddit fa-fw"}),
                    "/r/AdventureGuild"
                  ])
                ]),
                m("li", [
                  m("a", {target: "_blank", href: "http://twitch.tv/YesAndGames"}, [
                    m("i", {class: "fa fa-twitch fa-fw"}),
                    "/YesAndGames"
                  ])
                ]),
                m("li", [
                  m("a", {target: "_blank", href: "http://kickstarter.com/projects/yesandgames/adventure-guild"}, [
                    m("i", {class: "fa fa-external-link fa-fw"}),
                    "Kickstarter"
                  ])
                ]),
                m("li", [
                  m("a", {onclick: function(e){m.route("/press");}}, [
                    m("i", {class: "fa fa-newspaper-o fa-fw"}),
                    "Presskit"
                  ])
                ]),
              ])
              ...
              m("ul", [
                m("li", [
                  m("a", {onclick: function(e) {m.route("/updates");}}, [
                    m("i", {class: "fa fa-sticky-note fa-fw"}),
                    "Patch Notes"
                  ])
                ]),
                m("li", [
                  m("a", {onclick: function(e) {openModal(e, contactUsModal);}}, [
                    m("i", {class: "fa fa-bug fa-fw"}),
                    "Found a Bug?"
                  ])
                ]),
                m("li", [
                  m("a", {onclick: function(e) {openModal(e, contactUsModal);}}, [
                    m("i", {class: "fa fa-envelope fa-fw"}),
                    "Contact Support"
                  ])
                ]),
                m("li", [
                  m("a", {onclick: function(e) {m.route("/privacy");}}, [
                    m("i", {class: "fa fa-lock fa-fw"}),
                    "Terms and Privacy"
                  ])
                ]),
              ])
