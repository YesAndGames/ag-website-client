...
var Module = {
  ...
  codeUrl: "js/plugins/ag-character-creator.js",
  memUrl: "js/plugins/ag-character-creator.mem",
};
...
function LoadJSCode(e, t) {
  ...
  if (Math.fround && -1 == browser.indexOf("Chrome")) LoadJSCodeBlob(n, t);
  else {
    console.log("optimizing out Math.fround calls");
    var o = new FileReader;
    o.onload = function(e) {
      var n = e.target.result.replace(/Math_fround\(/g, "("),
        o = new Blob([n], {
          type: "text/javascript"
        });
      LoadJSCodeBlob(o, t)
...
function DecompressAndLoadFile(e, t, n) {
  ...
  o.open("GET", e, !0), o.onprogress = n, o.responseType = "arraybuffer", o.onload = function() {
    var n = new Uint8Array(o.response),
      ...
      i = pako.inflate(n),
      r = (new Date).getTime();
    console.log("Decompressed " + e + " in " + (r - a) + "ms. You can remove this delay if you configure your web server to host files using gzip compression."), t(i)
  }, o.send(null)
}
  ...
  LoadCompressedFile(e, n, function(n) {
    ...
    if (n.total && (a = n.total), n.loaded) {
      ...
      for (var l in Module.dataFileDownloads) {
        ...
        i += d.total, r += d.loaded, s++
      }
      i = Math.ceil(i * Module.expectedDataFileDownloads / s), Module.setStatus && Module.setStatus("Downloading data... (" + r + "/" + i + ")")
  ...
  function(e) {
    ...
    return function e(t, n, o) {
      ...
      1: [function(e, t, n) {
        ...
        var a = {
            arraySet: function(e, t, n, o, a) {
              if (t.subarray && e.subarray) return void e.set(t.subarray(n, n + o), a);
              for (var i = 0; o > i; i++) e[a + i] = t[n + i]
            },
            flattenChunks: function(e) {
              var t, n, o, a, i, r;
              for (o = 0, t = 0, n = e.length; n > t; t++) o += e[t].length;
              for (r = new Uint8Array(o), a = 0, t = 0, n = e.length; n > t; t++) i = e[t], r.set(i, a), a += i.length;
              return r
            }
          },
          i = {
      ...
      2: [function(e, t, n) {
        ...
        function o(e, t) {
          if (65537 > t && (e.subarray && r || !e.subarray && i)) return String.fromCharCode.apply(null, a.shrinkBuf(e, t));
        ...
        for (var l = new a.Buf8(256), d = 0; 256 > d; d++) l[d] = d >= 252 ? 6 : d >= 248 ? 5 : d >= 240 ? 4 : d >= 224 ? 3 : d >= 192 ? 2 : 1;
        l[254] = l[254] = 1, n.string2buf = function(e) {
          var t, n, o, i, r, s = e.length,
            l = 0;
          for (i = 0; s > i; i++) n = e.charCodeAt(i), 55296 === (64512 & n) && s > i + 1 && (o = e.charCodeAt(i + 1), 56320 === (64512 & o) && (n = 65536 + (n - 55296 << 10) + (o - 56320), i++)), l += 128 > n ? 1 : 2048 > n ? 2 : 65536 > n ? 3 : 4;
          for (t = new a.Buf8(l), r = 0, i = 0; l > r; i++) n = e.charCodeAt(i), 55296 === (64512 & n) && s > i + 1 && (o = e.charCodeAt(i + 1), 56320 === (64512 & o) && (n = 65536 + (n - 55296 << 10) + (o - 56320), i++)), 128 > n ? t[r++] = n : 2048 > n ? (t[r++] = 192 | n >>> 6, t[r++] = 128 | 63 & n) : 65536 > n ? (t[r++] = 224 | n >>> 12, t[r++] = 128 | n >>> 6 & 63, t[r++] = 128 | 63 & n) : (t[r++] = 240 | n >>> 18, t[r++] = 128 | n >>> 12 & 63, t[r++] = 128 | n >>> 6 & 63, t[r++] = 128 | 63 & n);
          return t
        }, n.buf2binstring = function(e) {
          return o(e, e.length)
        }, n.binstring2buf = function(e) {
          for (var t = new a.Buf8(e.length), n = 0, o = t.length; o > n; n++) t[n] = e.charCodeAt(n);
          return t
        }, n.buf2string = function(e, t) {
          var n, a, i, r, s = t || e.length,
            d = new Array(2 * s);
          for (a = 0, n = 0; s > n;)
            if (i = e[n++], 128 > i) d[a++] = i;
            else if (r = l[i], r > 4) d[a++] = 65533, n += r - 1;
          else {
            for (i &= 2 === r ? 31 : 3 === r ? 15 : 7; r > 1 && s > n;) i = i << 6 | 63 & e[n++], r--;
            r > 1 ? d[a++] = 65533 : 65536 > i ? d[a++] = i : (i -= 65536, d[a++] = 55296 | i >> 10 & 1023, d[a++] = 56320 | 1023 & i)
          }
          return o(d, a)
      ...
      3: [function(e, t, n) {
        ...
        function o(e, t, n, o) {
          for (var a = 65535 & e | 0, i = e >>> 16 & 65535 | 0, r = 0; 0 !== n;) {
            r = n > 2e3 ? 2e3 : n, n -= r;
            do a = a + t[o++] | 0, i = i + a | 0; while (--r);
            a %= 65521, i %= 65521
          }
          return a | i << 16 | 0
        }
      ...
      5: [function(e, t, n) {
        ...
        function a(e, t, n, o) {
          var a = i,
            r = o + n;
          e = -1 ^ e;
          for (var s = o; r > s; s++) e = e >>> 8 ^ a[255 & (e ^ t[s])];
          return -1 ^ e
        }
        var i = o();
        t.exports = a
      ...
      7: [function(e, t, n) {
        ...
        t.exports = function(e, t) {
          var n, i, r, s, l, d, u, c, f, h, p, m, w, b, g, v, k, y, _, x, S, M, C, E, R;
          n = e.state, i = e.next_in, E = e.input, r = i + (e.avail_in - 5), s = e.next_out, R = e.output, l = s - (t - e.avail_out), d = s + (e.avail_out - 257), u = n.dmax, c = n.wsize, f = n.whave, h = n.wnext, p = n.window, m = n.hold, w = n.bits, b = n.lencode, g = n.distcode, v = (1 << n.lenbits) - 1, k = (1 << n.distbits) - 1;
          e: do {
            15 > w && (m += E[i++] << w, w += 8, m += E[i++] << w, w += 8), y = b[m & v];
            t: for (;;) {
              if (_ = y >>> 24, m >>>= _, w -= _, _ = y >>> 16 & 255, 0 === _) R[s++] = 65535 & y;
              else {
                if (!(16 & _)) {
                  if (0 === (64 & _)) {
                    y = b[(65535 & y) + (m & (1 << _) - 1)];
                ...
                x = 65535 & y, _ &= 15, _ && (_ > w && (m += E[i++] << w, w += 8), x += m & (1 << _) - 1, m >>>= _, w -= _), 15 > w && (m += E[i++] << w, w += 8, m += E[i++] << w, w += 8), y = g[m & k];
                n: for (;;) {
                  ...
                  if (S = 65535 & y, _ &= 15, _ > w && (m += E[i++] << w, w += 8, _ > w && (m += E[i++] << w, w += 8)), S += m & (1 << _) - 1, S > u) {
                    e.msg = "invalid distance too far back", n.mode = o;
                    break e
                  }
                  if (m >>>= _, w -= _, _ = s - l, S > _) {
                    if (_ = S - _, _ > f && n.sane) {
                      e.msg = "invalid distance too far back", n.mode = o;
                      break e
                    }
                    ...
                    for (; x > 2;) R[s++] = C[M++], R[s++] = C[M++], R[s++] = C[M++], x -= 3;
                    x && (R[s++] = C[M++], x > 1 && (R[s++] = C[M++]))
                  } else {
                    M = s - S;
                    do R[s++] = R[M++], R[s++] = R[M++], R[s++] = R[M++], x -= 3; while (x > 2);
                    x && (R[s++] = R[M++], x > 1 && (R[s++] = R[M++]))
                  }
                  break
                }
              }
          ...
          x = w >> 3, i -= x, w -= x << 3, m &= (1 << w) - 1, e.next_in = i, e.next_out = s, e.avail_in = r > i ? 5 + (r - i) : 5 - (i - r), e.avail_out = d > s ? 257 + (d - s) : 257 - (s - d), n.hold = m, n.bits = w
        }
      }, {}],
      8: [function(e, t, n) {
        "use strict";
        ...
        function i(e) {
          var t;
          return e && e.state ? (t = e.state, e.total_in = e.total_out = t.total = 0, e.msg = "", t.wrap && (e.adler = 1 & t.wrap), t.mode = U, t.last = 0, t.havedict = 0, t.dmax = 32768, t.head = null, t.hold = 0, t.bits = 0, t.lencode = t.lendyn = new b.Buf32(pe), t.distcode = t.distdyn = new b.Buf32(me), t.sane = 1, t.back = -1, R) : L
        }

        function r(e) {
          var t;
          return e && e.state ? (t = e.state, t.wsize = 0, t.whave = 0, t.wnext = 0, i(e)) : L
        }
        ...
        function l(e, t) {
          var n, o;
          return e ? (o = new a, e.state = o, o.window = null, n = s(e, t), n !== R && (e.state = null), n) : L
        }
        ...
        function u(e) {
          if (ge) {
            ...
            for (y(x, e.lens, 0, 288, m, 0, e.work, {
                bits: 9
              }), t = 0; 32 > t;) e.lens[t++] = 5;
            y(S, e.lens, 0, 32, w, 0, e.work, {
              bits: 5
            }), ge = !1
          }
        ...
        function c(e, t, n, o) {
          var a, i = e.state;
          return null === i.window && (i.wsize = 1 << i.wbits, i.wnext = 0, i.whave = 0, i.window = new b.Buf8(i.wsize)), o >= i.wsize ? (b.arraySet(i.window, t, n - i.wsize, i.wsize, 0), i.wnext = 0, i.whave = i.wsize) : (a = i.wsize - i.wnext, a > o && (a = o), b.arraySet(i.window, t, n - o, a, i.wnext), o -= a, o ? (b.arraySet(i.window, t, n - o, o, 0), i.wnext = o, i.whave = i.wsize) : (i.wnext += a, i.wnext === i.wsize && (i.wnext = 0), i.whave < i.wsize && (i.whave += a))), 0
        }

        function f(e, t) {
          var n, a, i, r, s, l, d, f, h, p, m, w, pe, me, we, be, ge, ve, ke, ye, _e, xe, Se, Me, Ce = 0,
            Ee = new b.Buf8(4),
            Re = [16, 17, 18, 0, 8, 7, 9, 6, 10, 5, 11, 4, 12, 3, 13, 2, 14, 1, 15];
          if (!e || !e.state || !e.output || !e.input && 0 !== e.avail_in) return L;
          n = e.state, n.mode === J && (n.mode = K), s = e.next_out, i = e.output, d = e.avail_out, r = e.next_in, a = e.input, l = e.avail_in, f = n.hold, h = n.bits, p = l, m = d, xe = R;
          e: for (;;) switch (n.mode) {
            case U:
              if (0 === n.wrap) {
                n.mode = K;
              ...
              if (2 & n.wrap && 35615 === f) {
                n.check = 0, Ee[0] = 255 & f, Ee[1] = f >>> 8 & 255, n.check = v(n.check, Ee, 2, 0), f = 0, h = 0, n.mode = O;
                break
              }
            ...
            case P:
              ...
              n.mode = N;
            case N:
              if (1024 & n.flags && (w = n.length, w > l && (w = l), w && (n.head && (_e = n.head.extra_len - n.length, n.head.extra || (n.head.extra = new Array(n.head.extra_len)), b.arraySet(n.head.extra, a, r, w, _e)), 512 & n.flags && (n.check = v(n.check, a, w, r)), l -= w, r += w, n.length -= w), n.length)) break e;
              n.length = 0, n.mode = q;
            case q:
              if (2048 & n.flags) {
                if (0 === l) break e;
                w = 0;
                do _e = a[r + w++], n.head && _e && n.length < 65536 && (n.head.name += String.fromCharCode(_e)); while (_e && l > w);
                if (512 & n.flags && (n.check = v(n.check, a, w, r)), l -= w, r += w, _e) break e
            ...
            case G:
              if (4096 & n.flags) {
                if (0 === l) break e;
                w = 0;
                do _e = a[r + w++], n.head && _e && n.length < 65536 && (n.head.comment += String.fromCharCode(_e)); while (_e && l > w);
                if (512 & n.flags && (n.check = v(n.check, a, w, r)), l -= w, r += w, _e) break e
            ...
            case W:
              if (0 === n.havedict) return e.next_out = s, e.avail_out = d, e.next_in = r, e.avail_in = l, n.hold = f, n.bits = h, D;
            ...
            case V:
              if (w = n.length) {
                ...
                b.arraySet(i, a, r, w, s), l -= w, r += w, d -= w, s += w, n.length -= w;
                break
              }
              n.mode = J;
              break;
            ...
            case $:
              ...
              if (n.lencode = n.lendyn, n.lenbits = 7, Se = {
                  bits: n.lenbits
                }, xe = y(_, n.lens, 0, 19, n.lencode, 0, n.work, Se), n.lenbits = Se.bits, xe) {
            ...
            case ee:
              ...
              if (n.lenbits = 9, Se = {
                  bits: n.lenbits
                }, xe = y(x, n.lens, 0, n.nlen, n.lencode, 0, n.work, Se), n.lenbits = Se.bits, xe) {
                e.msg = "invalid literal/lengths set", n.mode = ce;
                break
              }
              if (n.distbits = 6, n.distcode = n.distdyn, Se = {
                  bits: n.distbits
                }, xe = y(S, n.lens, n.nlen, n.ndist, n.distcode, 0, n.work, Se), n.distbits = Se.bits, xe) {
            ...
            case ne:
              if (l >= 6 && d >= 258) {
                e.next_out = s, e.avail_out = d, e.next_in = r, e.avail_in = l, n.hold = f, n.bits = h, k(e, m), s = e.next_out, i = e.output, d = e.avail_out, r = e.next_in, a = e.input, l = e.avail_in, f = n.hold, h = n.bits, n.mode === J && (n.back = -1);
                break
              }
            ...
            case ae:
              ...
              n.offset = ge, n.extra = 15 & be, n.mode = ie;
            case ie:
              if (n.extra) {
                for (Me = n.extra; Me > h;) {
                  if (0 === l) break e;
            ...
            case re:
              ...
              } else me = i, pe = s - n.offset, w = n.length;
              w > d && (w = d), d -= w, n.length -= w;
              do i[s++] = me[pe++]; while (--w);
              0 === n.length && (n.mode = ne);
              break;
            case se:
              if (0 === d) break e;
              i[s++] = n.length, d--, n.mode = ne;
              break;
            case le:
              if (n.wrap) {
                for (; 32 > h;) {
                ...
                if (m -= d, e.total_out += m, n.total += m, m && (e.adler = n.check = n.flags ? v(n.check, i, m, s - m) : g(n.check, i, m, s - m)), m = d, (n.flags ? f : o(f)) !== n.check) {
          ...
          return e.next_out = s, e.avail_out = d, e.next_in = r, e.avail_in = l, n.hold = f, n.bits = h, (n.wsize || m !== e.avail_out && n.mode < ce && (n.mode < le || t !== M)) && c(e, e.output, e.next_out, m - e.avail_out) ? (n.mode = fe, z) : (p -= e.avail_in, m -= e.avail_out, e.total_in += p, e.total_out += m, n.total += m, n.wrap && m && (e.adler = n.check = n.flags ? v(n.check, i, m, e.next_out - m) : g(n.check, i, m, e.next_out - m)), e.data_type = n.bits + (n.last ? 64 : 0) + (n.mode === J ? 128 : 0) + (n.mode === te || n.mode === X ? 256 : 0), (0 === p && 0 === m || t === M) && xe === R && (xe = B), xe)
        }
        ...
        function p(e, t) {
          var n;
          return e && e.state ? (n = e.state, 0 === (2 & n.wrap) ? L : (n.head = t, t.done = !1, R)) : L
        }
        var m, w, b = e("../utils/common"),
          ...
          be = we,
          ge = !0;
        n.inflateReset = r, n.inflateReset2 = s, n.inflateResetKeep = i, n.inflateInit = d, n.inflateInit2 = l, n.inflate = f, n.inflateEnd = h, n.inflateGetHeader = p, n.inflateInfo = "pako inflate (from Nodeca project)"
      }, {
        "../utils/common": 1,
        "./adler32": 3,
        "./crc32": 5,
      ...
      9: [function(e, t, n) {
        ...
        t.exports = function(e, t, n, p, m, w, b, g) {
          var v, k, y, _, x, S, M, C, E, R = g.bits,
            F = 0,
            D = 0,
            L = 0,
            A = 0,
            ...
            j = 0;
          for (F = 0; a >= F; F++) N[F] = 0;
          for (D = 0; p > D; D++) N[t[n + D]]++;
          for (z = R, A = a; A >= 1 && 0 === N[A]; A--);
          if (z > A && (z = A), 0 === A) return m[w++] = 20971520, m[w++] = 20971520, g.bits = 1, 0;
          for (L = 1; A > L && 0 === N[L]; L++);
          for (L > z && (z = L), U = 1, F = 1; a >= F; F++)
            if (U <<= 1, U -= N[F], 0 > U) return -1;
          if (U > 0 && (e === s || 1 !== A)) return -1;
          for (q[1] = 0, F = 1; a > F; F++) q[F + 1] = q[F] + N[F];
          for (D = 0; p > D; D++) 0 !== t[n + D] && (b[q[t[n + D]]++] = D);
          if (e === s ? (T = G = b, S = 19) : e === l ? (T = u, P -= 257, G = c, j -= 257, S = 256) : (T = f, G = h, S = -1), Z = 0, D = 0, F = L, x = w, B = z, I = 0, y = -1, O = 1 << z, _ = O - 1, e === l && O > i || e === d && O > r) return 1;
          for (var H = 0;;) {
            H++, M = F - I, b[D] < S ? (C = 0, E = b[D]) : b[D] > S ? (C = G[j + b[D]], E = T[P + b[D]]) : (C = 96, E = 0), v = 1 << F - I, k = 1 << B, L = k;
            do k -= v, m[x + (Z >> I) + k] = M << 24 | C << 16 | E | 0; while (0 !== k);
            for (v = 1 << F - 1; Z & v;) v >>= 1;
            if (0 !== v ? (Z &= v - 1, Z += v) : Z = 0, D++, 0 === --N[F]) {
              if (F === A) break;
              F = t[n + b[D]]
            }
            if (F > z && (Z & _) !== y) {
              for (0 === I && (I = z), x += L, B = F - I, U = 1 << B; A > B + I && (U -= N[B + I], !(0 >= U));) B++, U <<= 1;
              if (O += 1 << B, e === l && O > i || e === d && O > r) return 1;
              y = Z & _, m[y] = z << 24 | B << 16 | x - w | 0
            }
          }
          return 0 !== Z && (m[x + Z] = F - I << 24 | 64 << 16 | 0), g.bits = z, 0
        }
      }, {
        "../utils/common": 1
      }],
      ...
      "/lib/inflate.js": [function(e, t, n) {
        ...
        h.prototype.push = function(e, t) {
          var n, o, a, d, u, c = this.strm,
            h = this.options.chunkSize;
          if (this.ended) return !1;
          o = t === ~~t ? t : t === !0 ? l.Z_FINISH : l.Z_NO_FLUSH, "string" == typeof e ? c.input = s.binstring2buf(e) : "[object ArrayBuffer]" === f.call(e) ? c.input = new Uint8Array(e) : c.input = e, c.next_in = 0, c.avail_in = c.input.length;
          do {
            if (0 === c.avail_out && (c.output = new r.Buf8(h), c.next_out = 0, c.avail_out = h), n = i.inflate(c, l.Z_NO_FLUSH), n !== l.Z_STREAM_END && n !== l.Z_OK) return this.onEnd(n), this.ended = !0, !1;
            c.next_out && (0 === c.avail_out || n === l.Z_STREAM_END || 0 === c.avail_in && (o === l.Z_FINISH || o === l.Z_SYNC_FLUSH)) && ("string" === this.options.to ? (a = s.utf8border(c.output, c.next_out), d = c.next_out - a, u = s.buf2string(c.output, a), c.next_out = d, c.avail_out = h - d, d && r.arraySet(c.output, c.output, a, d, 0), this.onData(u)) : this.onData(r.shrinkBuf(c.output, c.next_out)))
          } while (c.avail_in > 0 && n !== l.Z_STREAM_END);
          return n === l.Z_STREAM_END && (o = l.Z_FINISH), o === l.Z_FINISH ? (n = i.inflateEnd(this.strm), this.onEnd(n), this.ended = !0, n === l.Z_OK) : o === l.Z_SYNC_FLUSH ? (this.onEnd(l.Z_OK), c.avail_out = 0, !0) : !0
        ...
        }, n.Inflate = h, n.inflate = o, n.inflateRaw = a, n.ungzip = o
      }, {
        "./utils/common": 1,
        "./utils/strings": 2,
        "./zlib/constants": 4,
  ...
  function() {
    var e = function(e) {
      ...
      function n() {
        ...
        }, new t(0, 20595349, 0, 0).open("GET", "/data.unity3d"), new t(20595349, 20606424, 0, 0).open("GET", "/methods_pointedto_by_uievents.xml"), new t(20606424, 20616648, 0, 0).open("GET", "/preserved_derived_types.xml"), new t(20616648, 22937012, 0, 0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"), new t(22937012, 24433704, 0, 0).open("GET", "/Resources/unity_default_resources"), new t(24433704, 24461330, 0, 0).open("GET", "/Managed/mono/2.0/machine.config"), Module.addRunDependency("datafile_ag-character-creator.data"), Module.preloadResults || (Module.preloadResults = {}), Module.preloadResults[a] = {
          fromCache: !1
        }, l ? (n(l), l = null) : d = n
      }
      var o;
      ...
      var a = "ag-character-creator.data",
        i = "ag-character-creator.data";
      ...
      var r = "function" == typeof Module.locateFile ? Module.locateFile(i) : (Module.filePackagePrefixURL || "") + i,
        s = 24461330,
        l = null,
        d = null;
